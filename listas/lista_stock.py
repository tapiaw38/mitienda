...
def stockList():
    ...
    def editarProducto():
        ...
        if idSelecionado == "":
            ...
            Label(root2, text="** Este es el codigo de tu producto **", bg="white", fg="green", font=12).place(x=15, y=50)
    ...
    for producto in productos:
        lista.insert("", 0, text=str(producto[0]),
                     values=("ART-"+str(producto[0]),str(producto[1]), str(producto[2]), str(producto[3]), str(producto[4])))
